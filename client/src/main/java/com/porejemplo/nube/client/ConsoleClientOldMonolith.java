...
//
//public class ConsoleClientOldMonolith {
//
...
//
//    public ConsoleClientOldMonolith() {
//        try (Socket socket = new Socket(HOST, PORT);
//             DataOutputStream out = new DataOutputStream(socket.getOutputStream());
//             DataInputStream in = new DataInputStream(socket.getInputStream());) {
//
//            mainCommandHandler = new MainCommandHandler(new ConsoleClient(),new IOUploadService(out), new IODownloadService(out, in));
...
//
//            try {
//                mainCommandHandler.handle(outputStream, inputStream, command, arguments);
